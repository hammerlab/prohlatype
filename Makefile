...
build:
	ocamlbuild -use-ocamlfind $(foreach package, $(PACKAGES),-package $(package)) -I src/lib util.cmo mas_parser.cmo kmer_to_int.cmo kmer_table.cmo alleles.cmo ref_graph.cmo to_graph.cmo

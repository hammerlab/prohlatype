...
TOOLS=mhc2gpdf par_type multi_par viterbi align2fasta allele_distances
...
viterbi:
	ocamlbuild -use-ocamlfind $(foreach package, $(PACKAGES),-package $(package)) -I src/lib/ -I src/app viterbi.native

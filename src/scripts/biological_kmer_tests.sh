...
echo B_nuc    && ./biological_kmers.native B_nuc
echo C_gen    && ./biological_kmers.native C_gen
echo C_nuc    && ./biological_kmers.native C_nuc
echo DRB_nuc  && ./biological_kmers.native DRB_nuc
...
echo DOA_gen  && ./biological_kmers.native DOA_gen
echo DOA_nuc  && ./biological_kmers.native DOA_nuc
echo DOB_gen  && ./biological_kmers.native DOB_gen
...
echo DPB2_gen && ./biological_kmers.native DPB2_gen
...
echo DQB1_nuc && ./biological_kmers.native DQB1_nuc
